...
public class OrderControllerTest {
    ...
    public void addOrder() throws Exception {
        ...
        Mockito.when(orderService.addOrder(orderDto,"username")).thenReturn(Optional.of(newOrder));
        mvc.perform(
                        post("/order")
                                ...
                                .content(
                                        "{\"description\":\"Order #342\",\"departureAddress\":\"Moscow, st.Taganskaya 150\"," +
                                                "\"destinationAddress\":\"Moscow, st.Dubininskaya 39\",\"cost\":2450, \"count\":2}"
                                )
